...
exports = module.exports = function (app) {// routes
  ...
  app.get(/^\/(bj|cd|cq|cs|cc|cz|dl|dg|fs|fz|gz|gy|hz|hf|heb|hs|hd|hn|jn|jl|km|lz|ly|nj|nc|nb|nn|qd|sh|sy|sjz|suz|sz|tj|ty|ts|wh|wx|wz|xa|xm|xz|xn|xj|yt|yc|yic|zz)(\/*)$/, controller.index);
  //搜索页
