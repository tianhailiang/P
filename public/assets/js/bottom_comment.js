                      ...
                      '<div class="adviser-info" >'+
                        ...
                        '<div class="offer-xialas">'+
                          ...
                          '<ul class="offer-xiala">'+
                            ...
                            '</li>'+
                            '<li>'+
                              '<a class="dui-text-warning-s share-btn" data-artId="'+msg.data.list[i].id+'" data-title ="'+msg.data.list[i].id.title+'">分享</a>'+
                            '</li>'+
                          '</ul>'+
                        '</div>'+
                        '<p class="adviser-info-p">'+
                          '<a href="/article/'+ msg.data.list[i].id +'" class="dui-text-warning">'+msg.data.list[i].introduce+'<span>【查看详情】</span></a>'+
                        '</p>'+
...
function showbottom (type, uindex, index, usertype, category_id) {
  if (type === 1) {
