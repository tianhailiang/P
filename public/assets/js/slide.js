...
var iDcity1 = {
  ...
  50:['武昌','武昌分公司：武汉市洪山区珞瑜路10号群光中心百脑汇23层','服务专线：027-67811600'],
  51:['汉口','汉口分公司：武汉市航空路新世界中心C座20层','服务专线：027-83805656'],
...
function rand_zixun(country, catid, id, area, num, tp) {
  ...
  onclick_ly('g', tar);
  // var url = ajaxUrlPrefix.cmsapi+"/api/zixunCount";
  // $.ajax({
...
if("undefined" == typeof _areaCode){
  ...
  createStr += '<img src="http://www.jjl.cn/statics/images/tanchu2_bj1129.png" usemap="#Map" width="550" height="388" /><map name="Map" id="Map"><area shape="rect" coords="604,3,628,23" style="display:block;cursor:pointer;" onclick="javascript:closeDiv()"><area id="us_tc_bt" shape="rect" coords="105,209,203,250" style="display:block;cursor:pointer;" onclick="onclick_ly(\'g\',1)" /><area id="uk_tc_bt" shape="rect" coords="225,211,322,250" style="display:block;cursor:pointer;" onclick="onclick_ly(\'g\',1)" /><area id="ca_tc_bt" shape="rect" coords="344,211,442,250" style="display:block;cursor:pointer;" onclick="onclick_ly(\'g\',1)" /><area id="au_tc_bt" shape="rect" coords="103,269,202,308" style="display:block;cursor:pointer;" onclick="onclick_ly(\'g\',1)" /><area id="as_tc_bt" shape="rect" coords="225,269,321,308" style="display:block;cursor:pointer;" onclick="onclick_ly(\'g\',1)"/><area id="eu_tc_bt" shape="rect" coords="343,269,442,308" style="display:block;cursor:pointer;" onclick="onclick_ly(\'g\',\'874\')" /><area shape="rect" coords="510,5,539,34" style="display:block;cursor:pointer;" onclick="javascript:closeDiv()" /></map>';
