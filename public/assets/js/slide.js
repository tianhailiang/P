...
$(function(){
  var iDcity1 = {
    ...
    19:['长沙','长沙分公司：长沙市芙蓉区五一大道447号湖南投资大厦3层305室','服务专线：0731-82563355'],
  ...
  function openChat(c){
    //console.log(c)
    var url = "//jesong.jjl.cn/live/" +'chat.do?c=1';
...
//var _areaName=$('.city-cont [data-id='+_areaCode+']').attr('data-value')
    ...
    var _listStrAll='<li><a onclick="onclick_ly(\'g\',\'55\')"target="_blank">法国咨询</a></li>'+
     ...
     /* '<li><a onclick="onclick_ly(\'g\',\'174\')"target="_blank">境外升转学</a></li>'+*/
      '<li style="border:0px; height:124px; margin-top:6px;text-align: center"><img src="'+ajaxUrlPrefix.cdnhost+'/assets/img/weixin_zixun.png" width="112" height="114"></li>';
    ...
    if(_areaCode==1){
      ...
      _listStr='<li style="min-height: 50px;"><a onclick="onclick_ly(\'g\',\'40\')"target="_blank">('+_areaName+')英国/爱尔兰<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;中国香港/中国澳门</a></li>'+
      ...
      _listStr='<li style="min-height: 50px;"><a onclick="onclick_ly(\'g\',\''+myjson[_areaCode].a_uk+'\')"target="_blank">('+_areaName+')英国/爱尔兰<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;中国香港/中国澳门</a></li>'+
