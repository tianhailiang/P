...
//var _areaName=$('.city-cont [data-id='+_areaCode+']').attr('data-value')
    ...
    if(_areaCode==1){
      ...
      _listStr='<li><a onclick="onclick_ly(\'g\',\'40\')"target="_blank">('+_areaName+')英国/爱尔兰<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;中国香港/中国澳门</a></li>'+
      ...
      _listStr='<li><a onclick="onclick_ly(\'g\',\''+myjson[_areaCode].a_uk+'\')"target="_blank">('+_areaName+')英国/爱尔兰<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;中国香港/中国澳门</a></li>'+
