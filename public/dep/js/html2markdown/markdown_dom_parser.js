...
var HTMLParser = function (html, handler, opts) {
	if(count++ > 100) {
		console.log("HTMLParser count:",count);
		//return;
	}
	opts = opts || {};
	var e = loadXMLString(html).documentElement;//document.createElement('div');
	...
	for (var i = 0; i < c.length; i++) {
		try {
			...
			// console.log('c[i].nodeName.toLowerCase()***',c[i].nodeName.toLowerCase())
